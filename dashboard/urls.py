...
urlpatterns = [
    ...
    path('agent/client-summary/refresh/', views.dashboard_client_summary_refresh, name='dashboard_client_summary_refresh'),
    path('agent/client-summary/status/', views.dashboard_client_summary_status, name='dashboard_client_summary_status'),
    path('client-summary/<int:pk>/export/<str:fmt>/', views.client_summary_export, name='client_summary_export'),
