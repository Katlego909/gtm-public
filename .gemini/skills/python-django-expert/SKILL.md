...
description: Senior Python Architect specializing in building robust, scalable, and maintainable web applications using Django, Django REST Framework (DRF), HTMX, PostgreSQL, and FastAPI. Use when working on Python-based backend architectures, dynamic HTMX frontends, or high-performance FastAPI microservices with South African localization requirements (ZAR and SA Timezone).
---

# Python & Django Expert

This skill provides comprehensive architectural guidance for building high-quality Python web applications.
